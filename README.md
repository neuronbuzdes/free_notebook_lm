...
# free_notebook_lm: The Open Source NotebookLM Alternative
...
That's exactly what we've done with **free_notebook_lm**. This project is an open-source, self-hostable alternative to NotebookLM. It's designed to be a powerful AI research tool that grounds its responses exclusively in the sources you provide, making it a reliable window into your company's knowledge base.


## About The Project

NotebookLM is one of the most powerful AI research tools available today. However, its closed-source nature limits its potential for customization and private hosting. free_notebook_lm was created to bridge this gap.
...
We are open-sourcing free_notebook_lm so you can install it, customize it, improve it, and even commercialize it. The ability to deploy AI agents grounded in a company's specific knowledge (a concept known as Retrieval-Augmented Generation or RAG) represents one of the biggest commercial opportunities for generative AI today.



## Fully Local Version

This version of free_notebook_lm relies on cloud AI services like OpenAI and Gemini.

## Join Our Community

If you're interested in learning how to customize free_notebook_lm or build similar applications, join our community:

https://t.me/neuron_skills
...
For a complete demonstration of free_notebook_lm, an overview of its architecture, and a step-by-step guide on how to set it up, check out our YouTube video:

<p>
  <a target="_blank" href="https://www.youtube.com/@NeuralNetworksAI"></a>
</p>
